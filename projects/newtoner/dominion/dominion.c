...
void adventurerCardEffect(int* drawntreasure, struct gameState *state, int currentPlayer, int temphand[], int* z)
{
  int cardDrawn;
...
void feastCardEffect(int currentPlayer, struct gameState *state, int temphand[], int choice1, int handPos)
{
...
int mineCardEffect(int currentPlayer, struct gameState *state, int choice1, int choice2, int handPos)
{
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
      adventurerCardEffect(&drawntreasure, state, currentPlayer, temphand, &z);
      
      return 0;
			
    case council_room:
      //+4 Cards
      council_roomCardEffect(currentPlayer, state, handPos);
      
      return 0;
			
    case feast:
      feastCardEffect(currentPlayer, state, temphand, choice1, handPos);
    ...
    case mine:
      return mineCardEffect(currentPlayer, state, choice1, choice2, handPos);
